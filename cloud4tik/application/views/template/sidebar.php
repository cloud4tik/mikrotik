...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            <li class="header">CLOUD4TIK MENU</li>
...
<!--            <li class="treeview <?php echo ($this->uri->segment(1)) == "setting" ? "active" : "" ?>">
            ...
            <li class="header"></li>
            <li><a href="<?=site_url('/logout')?>" onclick="return confirm('Are you sure?')" id="logout-one"><i class="fa fa-power-off"></i><span>Logout</span></a></li>
