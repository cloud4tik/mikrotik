        ...
        <div class="wrapper">
            <header class="main-header">
                ...
                <a href="<?= base_url() ?>" onclick="return confirm('Are you sure?\nAll applications will be closed!')" class="logo">
                    ...
                    <span class="logo-mini"><b>c4t</b></span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg"><b>CLOUD4TIK</b></span>
                </a>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-footer">
                                        <div>
                                            <a href="<?=site_url('/logout')?>" onclick="return confirm('Are you sure?')" class="btn btn-block btn-danger btn-flat" id="logout-one"><i class="fa fa-power-off"></i> Logout</a>
                                        </div>
                                    </li>
                                </ul>
                            </li>
