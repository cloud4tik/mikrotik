				...
				<div class="box box-success bg-black text-black">
					...
					<div class="box-body" style="padding: 30px;">
						...
						<div class="row">
							<div class="col-md-4" style="color: #ddd">
								<h1 style="font-size: 2em;"><img src="<?php echo base_url('favicon.png') ?>" style="width:1.5em;"> 
								Cloud4Tik</h1>
					...
					<div class="box-footer no-border" style="background-color: #333; color: #ddd;">
						<strong>Copyright &copy; 2018
							<a href="javascript:void(0)" class="text-green">Cloud4Tik</a>.</strong> All rights reserved. Powered by Mikrostator
					</div>
					<!-- box-footer -->
				</div>
				<!-- /.box -->
